...
class Demo extends React.Component<DemoProps, DemoState> {
  ...
  render() {
    ...
    // importReactContent
    const importReactContent = code.importReactContent(suffix, sourceCodeTyped, sourceCode);
    ...
    const codesanboxPrefillConfig = {
      files: {
        ...
        [`demo.${suffix}`]: {
          content: code.demoJsContent(importReactContent[0], importReactContent[1]),
        },
        'index.html': {
          content: code.html,
        },
          ...
          <div className="code-box-actions">
            ...
            >
              <input
                type="hidden"
                name="data"
                value={JSON.stringify(code.codepenPrefillConfig(localizedTitle, sourceCode))}
              />
